...
export class ShopItem extends Component {
    ...
    save = (e) => {
        ...
        // Close Modal
        document.getElementById(`shop_item_${this.props.item.id}`).close();
    ...
    uploadImage = async (files) => {
        ...
        const response = await axios.post(`${process.env.REACT_APP_API_SERVER}/client/uploadmodulestoreimage`, formData).catch(e => { });
    ...
    render() {
        return (
            ...
            <>
                <dialog id={`shop_item_${this.props.item.id}`} class="modal px-[15%]">
                    <div class="modal-box w-full max-w-full">
                            ...
                            <div className='flex flex-col gap-y-7'>
                                <div className='w-full'>
                                    <label class="form-control w-full ">
                                        ...
                                        }} type="text" value={this.state.name} class={`input input-bordered w-full ${this.state.error ? "input-error" : ""}`} />
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="form-control w-full ">
                                        ...
                                        }} type="text" value={this.state.description} class="textarea input-bordered w-full" />
                                    </label>
                                </div>
                                ...
                                <div className='grid grid-cols-4 gap-x-6'>
                                    <div className='w-full'>
                                        <label class="form-control w-full ">
                                            ...
                                            }} type="number" value={this.state.price} class={`input input-bordered w-full ${this.state.error ? "input-error" : ""}`} />
                                        </label>
                                    </div>
                                    ...
                                    <div className='w-full'>
                                        <label class="form-control w-full ">
                                            ...
                                            }} type="number" value={this.state.itemLimit} class={`input input-bordered w-full ${this.state.error ? "input-error" : ""}`} />
                                        </label>
                                    </div>
                                ...
                                <div className='grid grid-cols-3 gap-x-6 py-3'>
                                    <div className='w-full'>
                                        <label class="form-control w-full flex flex-row items-center">
                                            ...
                                            <div className='flex ml-auto'>
                                                <Toggle value={this.state.destroyOnUse} onChange={(value) => {
                                                    this.setState({ destroyOnUse: value });
                                                }} className="ml-auto" color="primary" size="lg" />
                                            </div>
                                        </label>
                                    </div>
                                    ...
                                    <div className='w-full'>
                                        <label class="form-control w-full flex flex-row items-center">
                                            ...
                                            <div className='flex ml-auto'>
                                                <Toggle value={this.state.multiple} onChange={(value) => {
                                    ...
                                    <div className='w-full'>
                                        <label class="form-control w-full flex flex-row items-center">
                                            ...
                                            <div className='flex ml-auto'>
                                                <Toggle value={this.state.useOnBuy} onChange={(value) => {
                        ...
                        <div class="modal-action justify-start">
                            <Button className="btn-neutral">Delete Item</Button>
                ...
                {/* Modal End */}
                < div onClick={(e) => {
                    document.getElementById(`shop_item_${this.props.item.id}`).showModal();
                }
                } className=' cursor-pointer hover:opacity-60 opacity-w-[200px] h-[200px] flex flex-col items-center bg-darkGray rounded-md' >
                    ...
                    <div className='mt-auto w-full bg-grey text-center h-[20%]'>
                        <h1 className='text-white font-bold'>{this.props.item.name}</h1>
                    </div>
                </div>
            </>
        );
