...
export class Command extends Component {
    ...
    render() {
        return (
            <>
                <dialog id={`command_${this.props.module_id}.${this.props.command_index}`} class="modal">
                    <div class="modal-box">
                        {this.state.error ?
                        ...
                        <div className='w-full'>
                            ...
                            <div>
                                <label class="form-control w-full ">
                                    ...
                                    }} type="text" value={this.state.description} class="input input-bordered w-full" />
                                </label>
                            </div>
                        </div>
                        <div class="modal-action">
                            <Button onClick={(e) => {
                                ...
                                if (this.saveValidation()) {
                                    ...
                                    var module = server_settings.moduleSettings[this.props.module_id];
                                    ...
                                    var dialog = document.getElementById(`command_${this.props.module_id}.${this.props.command_index}`);
                                    dialog.close();
                                ...
                                this.state.name == "" || this.state.description == "" || this.state.loading == true
                            } className="btn" color="primary">Save</Button>
                            <form method="dialog">
                ...
                <div onClick={() => {
                    var dialog = document.getElementById(`command_${this.props.module_id}.${this.props.command_index}`);
                    dialog.showModal();
                }} className={`bg-menu-color ${this.props.command.enabled == false ? "opacity-70" : ""} flex items-center rounded-lg p-6 w-full`}>
                    <div>
                    ...
                    <div className='ml-auto' onClick={(e) => {
                        ...
                        <Toggle value={this.props.command.enabled != false ? true : false} onChange={(value) => {
                            console.log(this);
                            var server_settings = this.props.serverSettings;
